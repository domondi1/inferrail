...
(`inferrail.config.quickstart`) so this needs
no `inferrail.yaml` and no API key: OpenAPI generation only inspects
route/schema definitions, never calls a provider.
"""
